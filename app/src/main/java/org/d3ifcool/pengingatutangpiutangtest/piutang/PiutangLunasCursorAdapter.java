...
public class PiutangLunasCursorAdapter extends CursorAdapter {
    ...
    public PiutangLunasCursorAdapter(Context context, Cursor c) {
        super(context, c, 0 /* flags */);
    }

    @Override
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.piutang_lunas_items, parent, false);
    }

    @Override
    public void bindView(View view, Context context, Cursor cursor) {
        mDeskripsiText = (TextView) view.findViewById(R.id.recycle_deskripsi_piutang_lunas);
        mTitleText = (TextView) view.findViewById(R.id.recycle_title_piutang_lunas);
        mDateAndTimeText = (TextView) view.findViewById(R.id.recycle_date_time_piutang_lunas);
        mRepeatInfoText = (TextView) view.findViewById(R.id.recycle_repeat_info_piutang_lunas);
        mThumbnailImage = (ImageView) view.findViewById(R.id.thumbnail_image_piutang_lunas);
