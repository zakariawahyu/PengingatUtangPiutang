...
public class TambahPiutang extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener,LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private boolean mPiutangHasChanged = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsave = findViewById(R.id.btn_simpan_piutang);
        ...
        if (mCurrentPiutangUri == null) {
            ...
            setTitle("Tambah Data Piutang");

        } else {

            setTitle("Edit Data Piutang");

            getLoaderManager().initLoader(EXISTING_PIUTANG_LOADER, null, this);
        }

        mTitleText = (EditText) findViewById(R.id.et_nama_piutang);
        mJumlahText = (EditText) findViewById(R.id.et_jmlpiutang);
        mDeskripsiText = (EditText) findViewById(R.id.et_deskripsi_piutang);
        mDateText = (TextView) findViewById(R.id.set_date_piutang);
        mTimeText = (TextView) findViewById(R.id.set_time_piutang);
        mRepeatText = (TextView) findViewById(R.id.set_repeat_piutang);
        mRepeatNoText = (TextView) findViewById(R.id.set_repeat_no_piutang);
        mRepeatTypeText = (TextView) findViewById(R.id.set_repeat_type_piutang);
        mRepeatSwitch = (Switch) findViewById(R.id.repeat_switch_piutang);
        mFAB1 = (FloatingActionButton) findViewById(R.id.starrted1piutang);
        mFAB2 = (FloatingActionButton) findViewById(R.id.starrted2piutang);
    ...
    public void setTimePiutang(View v) {
    ...
    public void setDatePiutang(View v) {
        Calendar now = Calendar.getInstance();
    ...
    public void selectFab1Piutang(View v) {
        mFAB1 = (FloatingActionButton) findViewById(R.id.starrted1piutang);
        mFAB1.setVisibility(View.GONE);
        mFAB2 = (FloatingActionButton) findViewById(R.id.starrted2piutang);
        mFAB2.setVisibility(View.VISIBLE);
    ...
    public void selectFab2Piutang(View v) {
        mFAB2 = (FloatingActionButton) findViewById(R.id.starrted2piutang);
        mFAB2.setVisibility(View.GONE);
        mFAB1 = (FloatingActionButton) findViewById(R.id.starrted1piutang);
        mFAB1.setVisibility(View.VISIBLE);
    ...
    public void onSwitchRepeatPiutang(View view) {
    ...
    public void selectRepeatTypePiutang(View v) {
    ...
    public void setRepeatNoPiutang(View v) {
...
*/
        ...
        if (mCurrentPiutangUri == null) {
            ...
            if (mTitle == null){
                Toast.makeText(TambahPiutang.this, "Nama tidak boleh kosong", Toast.LENGTH_SHORT).show();
            } else if (mJum == null){
                Toast.makeText(TambahPiutang.this, "Jumlah tidak boleh kosong", Toast.LENGTH_SHORT).show();
            } else if (mDes == null){
                Toast.makeText(TambahPiutang.this, "Deskripsi tidak boleh kosong", Toast.LENGTH_SHORT).show();
            } else {
                Uri newUri = getContentResolver().insert(UtangPiutangContract.UtangPiutangEntry.CONTENT_URI_PIUTANG, values);

                // Create a new notification
                if (mActive.equals("true")) {
                    if (mRepeat.equals("true")) {
                        new AlarmScheduler().setRepeatAlarm(getApplicationContext(), selectedTimestamp, mCurrentPiutangUri, mRepeatTime);
                    } else if (mRepeat.equals("false")) {
                        new AlarmScheduler().setAlarm(getApplicationContext(), selectedTimestamp, mCurrentPiutangUri);
                    }
