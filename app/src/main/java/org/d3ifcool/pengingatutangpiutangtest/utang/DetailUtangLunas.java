...
public class DetailUtangLunas extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    private boolean mHasChanged;
    private Uri mCurrentUtangLunasUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_utang_lunas);

        Intent intent = getIntent();
        mCurrentUtangLunasUri = intent.getData();

        if (mCurrentUtangLunasUri == null) {
            mHasChanged = true;
        ...
        mJumlah = findViewById(R.id.tv_jumlah_detail_utang_lunas);
        mJumlahSisa = findViewById(R.id.tv_jumlahsisa_detail_utang_lunas);
        mNama = findViewById(R.id.tv_nama_detail_utang_lunas);
        mDeskripsi = findViewById(R.id.tv_deskirpsi_detail_utang_lunas);
        mTanggal = findViewById(R.id.tv_tanggal_detail_utang_lunas);
        mStatus = findViewById(R.id.tv_status_detail_utang_lunas);
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(this,   // Parent activity context
                mCurrentUtangLunasUri,         // Query the content URI for the current reminder
