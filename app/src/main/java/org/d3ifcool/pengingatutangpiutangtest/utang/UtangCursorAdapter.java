...
public class UtangCursorAdapter extends CursorAdapter {
    ...
    public UtangCursorAdapter(Context context, Cursor c) {
        super(context, c, 0 /* flags */);
    }

    @Override
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.utang_items, parent, false);
    }

    @Override
    public void bindView(View view, Context context, Cursor cursor) {
        mDeskripsiText = (TextView) view.findViewById(R.id.recycle_deskripsi_utang);
        mTitleText = (TextView) view.findViewById(R.id.recycle_title_utang);
        mDateAndTimeText = (TextView) view.findViewById(R.id.recycle_date_time_utang);
        mRepeatInfoText = (TextView) view.findViewById(R.id.recycle_repeat_info_utang);
        mActiveImage = (ImageView) view.findViewById(R.id.active_image_utang);
        mThumbnailImage = (ImageView) view.findViewById(R.id.thumbnail_image_utang);
